        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            className={`px-3 py-1.5 text-xs font-semibold rounded-full transition-all duration-300 ${
              isScientific 
                ? 'bg-primary-500 text-white shadow-[0_0_10px_rgba(99,102,241,0.5)]' 
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <AnimatePresence>
            {isScientific && (
              ...
              >
                <button onClick={() => handleScientific('sin')} className="p-2 bg-slate-800 hover:bg-slate-700 text-primary-300 rounded-xl font-medium text-xs transition-all active:scale-95">sin</button>
                <button onClick={() => handleScientific('cos')} className="p-2 bg-slate-800 hover:bg-slate-700 text-primary-300 rounded-xl font-medium text-xs transition-all active:scale-95">cos</button>
                <button onClick={() => handleScientific('tan')} className="p-2 bg-slate-800 hover:bg-slate-700 text-primary-300 rounded-xl font-medium text-xs transition-all active:scale-95">tan</button>
                <button onClick={() => handleScientific('pi')} className="p-2 bg-slate-800 hover:bg-slate-700 text-primary-300 rounded-xl font-medium text-xs transition-all active:scale-95">π</button>
                <button onClick={() => handleScientific('e')} className="p-2 bg-slate-800 hover:bg-slate-700 text-primary-300 rounded-xl font-medium text-xs transition-all active:scale-95">e</button>
                
                <button onClick={() => handleScientific('log')} className="p-2 bg-slate-800 hover:bg-slate-700 text-primary-300 rounded-xl font-medium text-xs transition-all active:scale-95">log</button>
                <button onClick={() => handleScientific('ln')} className="p-2 bg-slate-800 hover:bg-slate-700 text-primary-300 rounded-xl font-medium text-xs transition-all active:scale-95">ln</button>
                <button onClick={() => handleScientific('sqrt')} className="p-2 bg-slate-800 hover:bg-slate-700 text-primary-300 rounded-xl font-medium text-xs transition-all active:scale-95">√</button>
                <button onClick={() => handleScientific('sq')} className="p-2 bg-slate-800 hover:bg-slate-700 text-primary-300 rounded-xl font-medium text-xs transition-all active:scale-95">x²</button>
                <button onClick={() => handleOperator('^')} className="p-2 bg-slate-800 hover:bg-slate-700 text-primary-300 rounded-xl font-medium text-xs transition-all active:scale-95">x^y</button>
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <button onClick={() => handleOperator('÷')} className="p-4 bg-primary-600 hover:bg-primary-500 text-white rounded-2xl font-semibold text-2xl transition-all active:scale-95">÷</button>

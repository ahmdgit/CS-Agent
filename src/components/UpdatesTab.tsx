            ...
            <div className="relative" ref={exportMenuRef}>
              ...
              {showExportMenu && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-slate-200 z-20 py-1">
                  ...
                  <button onClick={() => exportUpdates('template')} className="block w-full text-left px-4 py-2 text-sm text-primary-600 font-medium hover:bg-primary-50">Download Template</button>
                </div>
              )}
            </div>
                  ...
                  <div className="relative space-y-3">
                    {editingId === update.id ? (
                      ...
                      <>
                        ...
                        {update.link && (
                          <div className="mt-3">
                            <a href={DOMPurify.sanitize(update.link)} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm font-medium text-primary-600 hover:text-primary-700 hover:underline">

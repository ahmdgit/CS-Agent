...
export function DashboardTab({ onNavigate }: DashboardTabProps) {
  ...
  return (
    ...
    >
      {/* Welcome Card */}
      <motion.div variants={item} className="md:col-span-3 lg:col-span-2 bg-white/80 backdrop-blur-md rounded-3xl shadow-xl shadow-primary-900/5 border border-slate-200/60 p-8 flex flex-col justify-center">
      ...
      {stats.map((stat, idx) => {
        ...
        return (
          <motion.div 
            ...
            className="col-span-1 bg-white/90 backdrop-blur-sm rounded-3xl shadow-lg shadow-slate-200/40 border border-slate-200/60 p-6 flex flex-col justify-between hover:shadow-xl hover:shadow-primary-900/10 hover:border-primary-100 transition-all cursor-pointer group"
          >
      ...
      {/* Quick Tools */}
      <motion.div variants={item} className="md:col-span-3 lg:col-span-2 lg:row-span-2 bg-white/80 backdrop-blur-md rounded-3xl shadow-xl shadow-primary-900/5 border border-slate-200/60 p-6 flex flex-col">
      ...
      {/* Need a new template */}
      <motion.div variants={item} className="md:col-span-3 lg:col-span-2 bg-gradient-to-br from-primary-600 to-violet-700 rounded-3xl shadow-xl shadow-primary-900/10 border border-primary-500/50 p-8 text-white flex flex-col justify-center items-center text-center relative overflow-hidden">

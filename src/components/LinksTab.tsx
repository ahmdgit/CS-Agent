          ...
          >
            ...
            {links.length === 0 && (
              <Button
                onClick={startCreating}
                leftIcon={<Plus className="w-4 h-4" />}
                className="bg-primary-600 hover:bg-primary-700 shadow-sm mt-6"
              >
                Add Link
              </Button>
            )}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <a
                          ...
                          className="text-sm text-primary-600 hover:text-primary-800 hover:underline truncate font-mono flex items-center gap-1"
                          title={link.url}
                        >

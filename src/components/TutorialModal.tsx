          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="space-y-3 text-sm text-slate-600">
                <li className="flex gap-2"><span className="text-primary-600 font-bold">•</span> <span><strong className="text-slate-800">AI Draft & Save:</strong> Paste customer messages to get AI-generated replies. You can adjust the tone between Professional and Empathy Professional.</span></li>
                <li className="flex gap-2"><span className="text-primary-600 font-bold">•</span> <span><strong className="text-slate-800">Macros:</strong> Save, edit, import (Excel, CSV, JSON), and export your frequently used replies for quick access.</span></li>
                <li className="flex gap-2"><span className="text-primary-600 font-bold">•</span> <span><strong className="text-slate-800">Translator:</strong> Quickly translate text to different languages to assist global customers.</span></li>
                <li className="flex gap-2"><span className="text-primary-600 font-bold">•</span> <span><strong className="text-slate-800">Ask Captain:</strong> Format messy customer issues and notes into clear, structured escalation requests for your manager.</span></li>
                <li className="flex gap-2"><span className="text-primary-600 font-bold">•</span> <span><strong className="text-slate-800">Links:</strong> Save and manage important URLs like internal knowledge bases or policies.</span></li>
                <li className="flex gap-2"><span className="text-primary-600 font-bold">•</span> <span><strong className="text-slate-800">Calculator:</strong> Perform basic calculations or switch to scientific mode for advanced mathematical operations.</span></li>
                <li className="flex gap-2"><span className="text-primary-600 font-bold">•</span> <span><strong className="text-slate-800">Backup & Restore:</strong> Export all your app data (macros, links, templates, updates) to a JSON file and import it later.</span></li>
              </ul>
            </div>
            ...
            <div className="border-t border-slate-100 pt-6">
              ...
              <p className="text-sm text-slate-600 mb-4">
                ...
                <br/>
                <span className="text-xs text-slate-500 italic">Note: This requires a paid Google Cloud API key. See <a href="https://ai.google.dev/gemini-api/docs/billing" target="_blank" rel="noreferrer" className="text-primary-600 hover:underline">billing documentation</a>. Generation takes a few minutes.</span>
              </p>

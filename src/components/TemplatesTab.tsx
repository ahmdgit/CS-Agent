              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full pl-3 pr-10 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors appearance-none font-medium text-slate-800"
                  >
                    ...
                    <div key={field.id}>
                      ...
                      {managingFieldId === field.id ? (
                        <div className="p-3 bg-slate-100 rounded-lg border border-slate-200 space-y-2">
                          ...
                          <Button variant="ghost" size="sm" onClick={() => setTempOptions([...tempOptions, ''])} className="text-primary-600 hover:text-primary-700 mt-2" leftIcon={<Plus className="w-3 h-3"/>}>
                            Add Option
                          </Button>
                          <div className="flex justify-end gap-2 mt-3 pt-2 border-t border-slate-200">
                            ...
                            <Button size="sm" onClick={saveManagedOptions} className="bg-primary-600 hover:bg-primary-700">Save Options</Button>
                          </div>
                        </div>
                      ) : field.type === 'dropdown' ? (
                        <select
